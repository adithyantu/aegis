...
from lancedb._lancedb import AddColumnsResult, AddResult, AlterColumnsResult, DeleteResult, DropColumnsResult, IndexConfig, UpdateResult
from lancedb.embeddings.base import EmbeddingFunctionConfig
from lancedb.common import DATA, VEC
from lancedb.merge import LanceMergeInsertBuilder
from ..query import LanceTakeQueryBuilder, LanceVectorQueryBuilder
from ..table import AsyncTable, IndexStatistics, Table, Tags
...
class RemoteTable(Table):
    ...
    def create_scalar_index(self, column: str, index_type: Literal["BTREE", "BITMAP", "LABEL_LIST", "scalar"] = ..., *, replace: bool = ..., wait_timeout: Optional[timedelta] = ..., name: Optional[str] = ...): # -> None:
    ...
    def create_fts_index(self, column: str, *, replace: bool = ..., wait_timeout: Optional[timedelta] = ..., with_position: bool = ..., base_tokenizer: str = ..., language: str = ..., max_token_length: Optional[int] = ..., lower_case: bool = ..., stem: bool = ..., remove_stop_words: bool = ..., ascii_folding: bool = ..., ngram_min_length: int = ..., ngram_max_length: int = ..., prefix_only: bool = ..., name: Optional[str] = ...): # -> None:
        ...
    
    def create_index(self, metric=..., vector_column_name: str = ..., index_cache_size: Optional[int] = ..., num_partitions: Optional[int] = ..., num_sub_vectors: Optional[int] = ..., replace: Optional[bool] = ..., accelerator: Optional[str] = ..., index_type=..., wait_timeout: Optional[timedelta] = ..., *, num_bits: int = ..., name: Optional[str] = ..., train: bool = ...): # -> None:
    ...
    def add(self, data: DATA, mode: str = ..., on_bad_vectors: str = ..., fill_value: float = ..., progress: Optional[Union[bool, Callable, Any]] = ...) -> AddResult:
