...
from typing import Any, Dict, Iterable, List, Literal, Optional, TYPE_CHECKING, Union
...
from ._lancedb import Connection as LanceDbConnection, Session
...
class DBConnection(EnforceOverrides):
    ...
    def drop_table(self, name: str, namespace: Optional[List[str]] = ...):
    ...
    def drop_all_tables(self, namespace: Optional[List[str]] = ...):
        """
...
class LanceDBConnection(DBConnection):
    ...
    """
    def __init__(self, uri: URI, *, read_consistency_interval: Optional[timedelta] = ..., storage_options: Optional[Dict[str, str]] = ..., session: Optional[Session] = ..., _inner: Optional[LanceDbConnection] = ...) -> None:
        ...
    ...
    @classmethod
    def from_inner(cls, inner: LanceDbConnection): # -> Self:
        ...
    ...
    @override
    def create_table(self, name: str, data: Optional[DATA] = ..., schema: Optional[Union[pa.Schema, LanceModel]] = ..., mode: str = ..., exist_ok: bool = ..., on_bad_vectors: str = ..., fill_value: float = ..., embedding_functions: Optional[List[EmbeddingFunctionConfig]] = ..., *, namespace: Optional[List[str]] = ..., storage_options: Optional[Dict[str, str]] = ..., storage_options_provider: Optional[StorageOptionsProvider] = ..., data_storage_version: Optional[str] = ..., enable_v2_manifest_paths: Optional[bool] = ...) -> LanceTable:
    ...
    @override
    def open_table(self, name: str, *, namespace: Optional[List[str]] = ..., storage_options: Optional[Dict[str, str]] = ..., storage_options_provider: Optional[StorageOptionsProvider] = ..., index_cache_size: Optional[int] = ...) -> LanceTable:
    ...
    def clone_table(self, target_table_name: str, source_uri: str, *, target_namespace: Optional[List[str]] = ..., source_version: Optional[int] = ..., source_tag: Optional[str] = ..., is_shallow: bool = ...) -> LanceTable:
    ...
    @override
    def drop_table(self, name: str, namespace: Optional[List[str]] = ..., ignore_missing: bool = ...): # -> None:
        """Drop a table from the database.
...
class AsyncConnection:
    ...
    def is_open(self): # -> CoroutineType[Any, Any, Any]:
    ...
    async def table_names(self, *, namespace: Optional[List[str]] = ..., start_after: Optional[str] = ..., limit: Optional[int] = ...) -> Iterable[str]:
        """List all tables in this database, in sorted order
    ...
    async def open_table(self, name: str, *, namespace: Optional[List[str]] = ..., storage_options: Optional[Dict[str, str]] = ..., storage_options_provider: Optional[StorageOptionsProvider] = ..., index_cache_size: Optional[int] = ..., location: Optional[str] = ..., namespace_client: Optional[Any] = ..., managed_versioning: Optional[bool] = ...) -> AsyncTable:
        """Open a Lance Table in the database.
    ...
    async def clone_table(self, target_table_name: str, source_uri: str, *, target_namespace: Optional[List[str]] = ..., source_version: Optional[int] = ..., source_tag: Optional[str] = ..., is_shallow: bool = ...) -> AsyncTable:
        """Clone a table from a source table.
    ...
    async def rename_table(self, cur_name: str, new_name: str, cur_namespace: Optional[List[str]] = ..., new_namespace: Optional[List[str]] = ...): # -> None:
        """Rename a table in the database.
    ...
    async def drop_table(self, name: str, *, namespace: Optional[List[str]] = ..., ignore_missing: bool = ...): # -> None:
        """Drop a table from the database.
